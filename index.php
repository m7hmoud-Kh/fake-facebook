                ...
                <div class="post">
                  ...
                  <div class="comments">
                    ...
                    <form class="add-comment" action="#">
                      ...
                      ?>
                        <div class="img">
                          <img src="./assets/images/users/<?= $_SESSION['profile_image'] ?>" class="img-fluid" style="width: 45px" alt="" />
                        </div>
                      <?php
                      }
                      ?>
                  ...
                  <div class="setting">
                    <button class="btn btn-danger" data-bs-toggle="modal" data-post_id="<?= $post['post_id'] ?>" data-bs-target="#delete_post">
                      Delete
                    </button>
                  </div>
                </div>
